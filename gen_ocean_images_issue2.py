#!/usr/bin/env python3
"""Generate all images for Ocean Issue 002."""
...
images = [
    ("ch1-outer-lattice-fields.png",
     f"vast ocean floor stretching to horizon, long rows of glowing amber signal stones in grid formation, {MARINA} and {FLICK} and {WREN} small figures walking among the stones, midnight blue water, shafts of light from above, wide cinematic shot, photorealistic digital art"),
    ...
    ("ch3-vast-stone-grid.png",
     "enormous grid of glowing amber signal stones on ocean floor, rows of stones stretching to horizon, deep midnight blue water, bioluminescent glow, wide establishing shot, sense of vast scale, photorealistic digital art"),
    ("ch4-marina-wren-datapad.png",
     f"{MARINA} kneeling and studying glowing amber wrist datapad, {WREN} watching beside her, {FLICK} wing-tips flaring, rows of signal stones around them, one section of stones noticeably dark, photorealistic digital art"),
